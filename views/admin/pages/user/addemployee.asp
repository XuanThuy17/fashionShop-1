...
<body>
  <div class="container-scroller"> 
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input name="firstName" type="text" class="form-control" id="exampleInputName1" required placeholder="First Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Last Name</label>
                      <input name="lastName" type="text" class="form-control" id="exampleInputName1" required placeholder="Last Name">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Identity Card</label>
                      <input name="cmnd" type="text" class="form-control" id="exampleInputName1" required placeholder="Identity Card">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Phone Number</label>
                      <input name="phone_number" type="text" class="form-control" id="exampleInputCity1" required placeholder="Phone Number">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Birthday</label>
                      <input name="birthDay" type="date" class="form-control" id="exampleInputCity1" required placeholder="Birthday">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputCity1">Join on</label>
                      <input name="join" type="date" class="form-control" id="exampleInputCity1" required placeholder="Official Working Day">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Email address</label>
                      <input name="email" type="email" class="form-control" id="exampleInputEmail3" required placeholder="Email address">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">Password</label>
                      <input name="password" type="password" class="form-control" id="exampleInputPassword4" required placeholder="Password" onkeyup="validatePassword(this.value)">
    ...
    <script>
      ...
      // call ajax add account
      const addAccount = () => {
        email = document.querySelector('input[name="email"]').value;
        password = document.querySelector('input[name="password"]').value;

        alertEmptyForm(email)

        if (successPassword == true && successForm == true) {
          var xmlhttp = new XMLHttpRequest();
          xmlhttp.open("GET", "/fashionShop/controllers/admin/addAccount.asp?email=" + email + "&password="+password, true);
