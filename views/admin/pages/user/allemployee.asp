                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        cmdPrep.CommandText = "select CONCAT(users.firstName, ' ', users.lastName) as fullName, birthday, ID_user, joindate, phone_number, cmnd from users inner join account on account.ID_account = users.ID_account where account.role = '0'"
